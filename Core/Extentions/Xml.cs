...
namespace MeyerCorp.Usps.Core.Extensions
{
	...
	{
		///<summary>
		///Appends a string containing an XML element with optional simple content and any number of attributes formed from input parameters.
		///</summary>
		///<param cref="builder"></param>
		///<param cref="tag"></param>
		///<param cref="value"></param>
		///<param cref="attributeValuePairs"></param>
		///<exception cref="ArgumentNullException">The <paramref name="builder"/> parameter which this method is applied to is null.</exception>
		///<exception cref="ArgumentException">The <paramref name="tag"/> parameter is null, empty or whitespace.</exception>
		///<exception cref="ArgumentException">After filtering out any attribute tags and values in the <paramref name="attributeValuePairs"/> parameter which 
		...
		public static StringBuilder AppendXml(this StringBuilder builder, string tag, string value, params string[] attributeValuePairs)
		{
			...
			if (attributeValuePairs.Length < 1)
